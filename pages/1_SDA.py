            ...
            if params == 'Kemiringan Lereng':
                ...
                with left:
                    st.markdown('''
                                ...
                                Raster-30m
                                ''')
            if params == 'Jenis Tutupan Lahan (LULC)':
                st.markdown('''
                            :red[**Penjelasan**]  
            ...
            if params == 'Populasi':
                ...
                with left:
                    st.markdown('''
                                ...
                                Raster-100m
                                ''')
            if params == 'Normalized Difference Salinity Index':
                st.markdown('''
                            :red[**Penjelasan**]  
            ...
            if params == 'Infrastruktur Air':
                ...
                with left:
                    st.markdown('''
                                ...
                                Vektor-point
                                ''')
            if params == 'Produktivitas Pertanian Padi':
                st.markdown('''
                            :red[**Penjelasan**]  
